...
loaded_rf_tooth5 = joblib.load('pre_processed/best_rf_tooth5_age_model.pkl')
loaded_rf_tooth6 = joblib.load('pre_processed/best_rf_tooth6_age_model.pkl')
loaded_rf_tooth7 = joblib.load('pre_processed/best_rf_tooth7_age_model.pkl')
